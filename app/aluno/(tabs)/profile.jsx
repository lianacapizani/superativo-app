...
const pointsData = [
  {
    ...
    transactions: [
      { id: "t1", value: +200, date: "12/10/2025" },
      { id: "t2", value: -100, date: "08/10/2025" },
    ],
  },
  {
    id: "2",
    ...
    color: "#e0e7ffc7",
    transactions: [
      { id: "t3", value: +100, date:"10/10/2025" },
      { id: "t4", value: -50, date: "08/10/2025" },
    ],
  },
  {
    id: "3",
    ...
    color: "#fce8d9f7",
    transactions: [
      { id: "t5", value: +100, date: "10/10/2025" },
      { id: "t6", value: +100, date: "08/10/2025" },
    ],
  },
];
    ...
    >
      <View style={styles.hero}>
        ...
        <View style={styles.heroTextContainer}>
          <Text style={GlobalStyles.title}>Gabriela Rocha</Text>
          <View style={styles.row}>
            ...
            />
            <Text style={styles.subtitle}>Classificação Geral: 9º</Text>
          </View>
          ...
          <View style={styles.row}>
            <Ionicons
              ...
              color={Colors.primary750}
            />
            <Text style={styles.subtitle}>8ºA</Text>
          </View>
        </View>
      </View>
